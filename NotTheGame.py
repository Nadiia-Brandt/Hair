...
class Arrow (pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale (arrowImage, (50, 38))
...
class Score (object):
    def __init__(self):
        ...
        self.render = self.font.render ('Score: ' + str (self.total), True, BLACK, background)
...
def main():
    ...
    icon_game = pygame.image.load ('lollipop_red.png')
    pygame.display.set_icon (icon_game)
    pygame.display.set_caption ('Bubble Shoter')
...
def runGame():
    musicList = [ 'Cheers For Starlight Loop.mp3']
    ...
    setBubbles (bubbleArray, COLORLIST)
...
def coverNextBubble():
    ...
    pygame.draw.rect (DISPLAYSURF, background, whiteRect)


def endScreen(score, winorlose):
    endFont = pygame.font.SysFont ('Helvetica', 20)
    endMessage1 = endFont.render (
        'You ' + winorlose + '! Your Score is ' + str (score) + '. Press Enter to Play Again.', True, BLACK, background)
